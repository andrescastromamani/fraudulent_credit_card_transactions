...
from credit_card_fraud.api.model_loader import load_model, get_model_metadata, MODEL_NAME
...
# Intento de carga del Scaler
BASE_DIR = Path(__file__).resolve().parent.parent.parent
SCALER_PATH = BASE_DIR / "credit_card_fraud" / "models" / "scaler.pkl"
...
# Medias y desviaciones estándar globales del dataset original de Kaggle para respaldo
